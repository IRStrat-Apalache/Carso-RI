...
$(function () {
    ...
    //
    //     if (!$(e.target).hasClass('not-hover')) {
    ...
    // });
    //
    // $('.not-hover').hover(function (){
    //     $('.mega-menu').removeClass('mega-menu-visible');
    // }, function (){})
    //
    // $('.sub-active:not(.not-hover)').hover(function (){
    //     $('.mega-menu').addClass('mega-menu-visible');
    // }, function (){})
    //
    // var sub;
                ...
                if (contact_form.valid()) {
                    ...
                    grecaptcha.execute(site_key, {action: 'contactformexp'})
                        .then(function (token) {
                            ...
                            // let url = window.location.href.includes('contacto-exp') ? '/contact-form-exp' : '/contact-form';
                            let url = '';
                            let formData = new FormData(document.getElementById('contact-form'));
                            if (window.location.href.includes('contacto-exp')) {
                                url = '/contact-form-exp';
                            } else if (window.location.href.includes('denuncia')) {
                                url = '/denuncia-form';
                            } else {
                                url = '/contact-form';
                            }
                            ...
                            let ajaxOptions = {
                                type: 'POST',
                                url: url,
                                data: !window.location.href.includes('denuncia') ? contact_form.serialize() : formData,
                                success: function (response) {
                                    if (response.status === 'success') {
                                        $('input').val('');
                                        $('input').removeClass('is-valid valid');
                            ...
                            if (window.location.href.includes('denuncia')) {
